    ...
    <SafeAreaView style={styles.container} >
      ...
      <View>
        <Text style={styles.title}>
          Adjust the color in a way that look the color prop controls the color of the te background color of the button.
        </Text>
      ...
      <View>
        <Text style={styles.title}>
          This layout strategy lefts the title define the width of the button.
        </Text>
